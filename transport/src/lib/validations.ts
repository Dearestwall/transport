...
export const DriverSchema = z.object({
  ...
  per_trip_rate:     z.coerce.number().min(0).optional(),
  per_km_rate:       z.coerce.number().min(0).optional(),
...
// ─── Trip ────────────────────────────────────────────────────────────────────
// NOTE: uses departure_date / arrival_date / status to match your DB columns
export const TripSchema = z.object({
  ...
  freight_amount:   z.coerce.number().min(0),
  advance_paid:     z.coerce.number().min(0),
  status:           z.enum(['planned', 'in_transit', 'delivered', 'cancelled', 'on_hold']),
  notes:            z.string().optional(),
})
...
export const InvoiceSchema = z.object({
  ...
  advance_adjusted: z.coerce.number().min(0),
  notes:            z.string().optional(),
})
